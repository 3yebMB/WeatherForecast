...
import dev.m13d.weatherforecast.data.db.unitlocalized.future.detail.UnitSpecificDetailFutureWetherEntry
...
interface ForecastRepository {
    ...
    suspend fun getFutureWeatherByDate(date: LocalDate, metric: Boolean): LiveData<out UnitSpecificDetailFutureWetherEntry>
